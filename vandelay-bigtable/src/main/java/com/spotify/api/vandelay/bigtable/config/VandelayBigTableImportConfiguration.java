...
public class VandelayBigTableImportConfiguration extends VandelayBigTableConfiguration {

  @RequiredField private VandelayBigTableGCPConfiguration gcpConfiguration;
  @RequiredField private boolean createInstanceIfDoesntExist;
  @RequiredField private boolean createTableIfDoesntExist;

  VandelayBigTableImportConfiguration() {}
  ...
  public VandelayBigTableImportConfiguration(
    ...
    this.createInstanceIfDoesntExist = createInstanceIfDoesntExist;
    this.createTableIfDoesntExist = createTableIfDoesntExist;
  }

  public VandelayBigTableGCPConfiguration getGcpConfiguration() {
