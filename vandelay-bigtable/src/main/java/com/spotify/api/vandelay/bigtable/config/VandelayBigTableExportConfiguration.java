...
public class VandelayBigTableExportConfiguration extends VandelayBigTableConfiguration {

  @RequiredField private boolean deleteOnExport;
  @RequiredField private boolean parallelExport;

  VandelayBigTableExportConfiguration() {}
  ...
  public VandelayBigTableExportConfiguration(
    ...
    this.parallelExport = parallelExport;
  }

  public boolean getDeleteOnExport() {
    return deleteOnExport;
  }
